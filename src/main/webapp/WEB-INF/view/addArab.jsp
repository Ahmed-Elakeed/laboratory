        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <h2 style="text-align: center;color: darkblue">Add Arab Patient</h2>
                    <form method="post" id="signup-form" class="signup-form" action="/patients/add-arab">
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-input" name="IdNumber" id="Id" required/>
                            </div>
                            <div class="form-group">
