...
<%--                        <h2>Patient <b> Data</b></h2>--%>
                    ...
                    <img src="/resources/images/lap.jpeg" style="float: right;width: 150px;height: 150px"><br>
                </div>
            </div>
            <table class="table table-striped table-hover">
                ...
                <tbody>
                <tr>
                    <th style="border-right: 2px solid black;width: 200px">Surname</th>
                    <td>${foreignPatient.surName}</td>
                </tr>
                <tr>
                    <th style="border-right: 2px solid black;">Given Names</th>
                    <td>${foreignPatient.given_names}</td>
                </tr>
                <tr>
                    <th style="border-right: 2px solid black">Nationality</th>
                    <td>${foreignPatient.nationality}</td>
                </tr>
                <tr>
                    <th style="border-right: 2px solid black">Sex</th>
                    <td>${foreignPatient.sex}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>${foreignPatient.test}</td>
                </tr>
                <tr>
                    <th style="border-right: 2px solid black">Result</th>
                    <td>${foreignPatient.result}</td>
                </tr>
